 ...
 *  push parentheses into new string 
 * use if modulus statment to check odd/even parethentheses
 *  if # of parenthese is odd = false 
 *   else next if statment 
 * check whether first index == "(" && last index == ")"
 * If true return True
 * ELSE return false
 * 
 * 
